...
import com.example.quanlychitieu.Controller.Ctrl_ChiTietNganSach;
...
public class V_NganSach extends RecyclerView.Adapter<V_NganSach.ViewHolder> {
    ...
    public V_NganSach(Context context, List<M_NganSach> arrNganSach) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, Ctrl_ChiTietNganSach.class);
