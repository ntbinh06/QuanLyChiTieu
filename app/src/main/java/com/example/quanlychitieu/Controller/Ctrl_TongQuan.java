...
public class Ctrl_TongQuan extends AppCompatActivity {
    ...
    private void showDialog() {
        ...
        themthunhap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ctrl_TongQuan.this, Ctrl_ThemThuNhap.class);
        ...
        themchiphi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ctrl_TongQuan.this, Ctrl_ThemChiPhi.class);
                startActivity(intent);
            }
        });
        ...
        chuyentien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ctrl_TongQuan.this, Ctrl_ChuyenTien.class);
                startActivity(intent);
            }
        });
