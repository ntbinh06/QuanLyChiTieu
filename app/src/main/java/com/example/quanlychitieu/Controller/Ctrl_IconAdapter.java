...
public class Ctrl_IconAdapter extends RecyclerView.Adapter<Ctrl_IconAdapter.IconViewHolder> {

    private List<Integer> icons;
    private OnIconClickListener listener;

    // Constructor nhận danh sách icon và callback khi người dùng chọn icon
    public Ctrl_IconAdapter(List<Integer> icons, OnIconClickListener listener) {
        this.icons = icons;
