...
public class Ctrl_RecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public Ctrl_RecyclerViewItemClickListener(Context context, final RecyclerView recyclerView, final OnItemClickListener listener) {
